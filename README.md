...
_Front-End-Design-Engineering_
...
> # **Dica do Prof:** Lembrem-se de que a consistência visual é a chave para uma boa experiência de usuário (UX). Testem as resoluções utilizando o _Inspector_ do navegador.
